    ...
    <body>
        ...
        <div id="unpublishedCachesBlock">
            ...
            <div id="table-unpublished-caches">
                ...
                <button type="submit" class="btn btn-default" data-loading-text="Refreshing..." id="refresh-cache">Refresh the list</button>
                <button type="submit" class="btn btn-default" data-loading-text="Creating..." id="create-gpx">Create a GPX</button>
            </div>
        </div>
